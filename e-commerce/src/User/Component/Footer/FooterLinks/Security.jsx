          ...
          <div className="inner1prpo">
            <div>
              ...
              <div className="content-container">
                ...
                <p><strong>Is making online payment secure on TrendSphere</strong></p>

                <p>Yes, making the online payment is secure on TrendSphere</p>

                <p><strong>Does TrendSphere store my credit/debit card infomation?</strong></p>

                <p>No. TrendSphere only stores the last 4 digits of your card number for the purpose of card identification.</p>

                <p><strong>What credit/debit cards are accepted on TrendSphere?</strong></p>
                ...
                <p><strong>What other payment options are available on TrendSphere?</strong></p>
                ...
                <p>TrendSphere.com respects your privacy and is committed to protecting it. For more details, please see our <Link to="/privacy-policy">Privacy policy</Link></p>
