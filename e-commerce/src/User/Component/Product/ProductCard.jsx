          ...
          <div className="col-span-1 px-4 pb-15 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 max-w-2xl" >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <button
                  type="submit"
                  className="mt-10 flex w-[11rem] items-center justify-center rounded-md border border-transparent bg-lime-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <AddShoppingCartIcon />
                  Add to cart
                </button>
