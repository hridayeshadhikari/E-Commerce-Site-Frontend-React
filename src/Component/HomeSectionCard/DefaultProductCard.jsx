...
export default function DefaultProductCard({ product }) {
  ...
  return (
    <div onClick={() => navigate(`/product/${product?.productId}`)}>
      <Card
        sx={{ maxWidth: 345 }}
        className="cursor-pointer mt-5 items-center mx-3 flex h-[20rem] w-[15rem] flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md"
      >
        ...
        <div className="mt-3 px-5 pb-5">
          ...
          <div className="mt-2 mb-1 flex items-center justify-between">
            <p>
              ...
              <span className="text-sm text-green-500 p-1 line-through">
                ₹{product?.price}
              </span>
            </p>
          </div>
