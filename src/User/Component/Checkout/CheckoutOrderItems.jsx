                ...
                <div className='flex items-center'>
                    ...
                    <div className='ml-5'>
                        ...
                        <div className=" items-center justify-between">
                            <p>
                                <span className="text-lg font-semibold text-slate-900">₹{item.product.discountedPrice}</span>
                                <span className="text-md text-gray-500 p-2 line-through">₹{item.product.price}</span>
                                <span className="text-md text-green-500 p-2 ">₹{item.product.price-item.product.discountedPrice} Off</span>
